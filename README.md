...
## Algorithm
1. - Load & Clean Data → Read CSV, strip column names, sort by time, interpolate missing values.
2. - Feature Engineering → Create cyclical time features, add lag features, drop NaNs, define final feature set.
3. - Train/Test Split & Modeling → Chronologically split data, train Random Forest regressors for each target.
4. - Evaluate & Predict → Compute metrics, visualize results, and generate real‑time predictions from the latest row.
Would you like me to also condense this into a flowchart diagram so you can visualize the pipeline at a glance.
...
## Output:
<img width="1783" height="785" alt="image" src="https://github.com/user-attachments/assets/8afe4e0a-0472-4c22-a17c-aff3df874d63" />
<img width="1799" height="680" alt="image" src="https://github.com/user-attachments/assets/97f8036d-44d2-46ea-ae0c-356b318f8ff0" />
<img width="1762" height="816" alt="image" src="https://github.com/user-attachments/assets/ec7e9b36-92b1-47d1-b0a6-51c4eb85b7ae" />
...
## Result:
Weather prediction using Random Forest was done successfully, achieving accurate forecasts for temperature, PM2.5, and solar radiation.
